...
async def DGC_evaluate(
    ...
    for b in range(0, len(tasks), batch_size * (repeated_num + redundancy)):
        ...
        json_dump_path = './record/Diplomatic_Game_Choices_unreal_deepseekv3_raw-{}-temp-dsapi.json'.format(evaluated_language)
...
async def multi_evaluate(
    ...
    for test_language in tqdm(evaluate_languages, desc="Outer Loop"): # with different language
        ...
        json_dump_path = './record/Diplomatic_Game_Choices_unreal_deepseekv3_raw-{}-temp-dsapi.json'.format(test_language)
...
if __name__ == '__main__':
    ...
    json_dump_path = './record/Diplomatic_Game_Choices_unreal_deepseek_v3_raw-dsapi.json'
    write_to_json(total_task_info, json_dump_path)
