...
async def DGC_evaluate(
    ...
    for b in range(0, len(tasks), batch_size * (repeated_num + redundancy)):
        ...
        json_dump_path = './record/Diplomatic_Game_Choices_real_gpt4o_raw-{}-temp.json'.format(evaluated_language)
...
async def multi_evaluate(
    ...
    for test_language in tqdm(evaluate_languages, desc="Outer Loop"): # with different language
        ...
        json_dump_path = './record/Diplomatic_Game_Choices_real_gpt4o_raw-{}-temp.json'.format(test_language)
...
if __name__ == '__main__':
    ...
    # deepseek-v3
    game_name = read_json('./DGC/DGC_game_name-real.json')
    max_num = 1
    game_name = {
    ...
    country = read_json('./DGC/DGC_country-real.json')
    country_num = 10 # 25
    country = {
    ...
    json_dump_path = './record/Diplomatic_Game_Choices_real_gpt4o_raw-final.json'
    write_to_json(total_task_info, json_dump_path)
