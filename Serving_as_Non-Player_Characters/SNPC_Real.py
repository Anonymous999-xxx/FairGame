...
async def FGD_evaluate(
    ...
    for b in range(0, len(tasks), batch_size * (repeated_num + redundancy)):
        ...
        json_dump_path = './record/Fantasy_Game_Discounts_real_gpt4o_raw-{}-temp.json'.format(evaluated_language)
...
async def multi_evaluate(
    ...
    for test_language in tqdm(evaluate_languages, desc="Loop", leave=False): # with different language
        ...
        json_dump_path = './record/Fantasy_Game_Discounts_real_gpt4o_raw-{}-temp.json'.format(test_language)
...
if __name__ == '__main__':
    ...
    # "deepseek-chat"
    # "local"
    game_name = read_json('./FGD/FGD_game_name-real.json')
    max_num = 1
    game_name = {
    ...
    race = read_json('./FGD/FGD_race-real.json')
    career = read_json('./FGD/FGD_career-real.json')
    ...
    json_dump_path = './record/Fantasy_Game_Discounts_real_gpt4o_raw-final.json'
    write_to_json(total_task_info, json_dump_path)
